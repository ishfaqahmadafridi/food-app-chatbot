...
import { setCategory as ReduxSetCategory } from '../../redux/features/menu/menuSlice';

const ExploreMenuList = ({ category }) => {
                ...
                menu_list.map((item, index) => {
                    return (
                        <div
                            ...
                            key={index}
                            onClick={() => dispatch(ReduxSetCategory(category === item.menu_name ? 'All' : item.menu_name))}
                        >
                            <img
